...
session_start();
$_SESSION['adm_email'] = null;
$_SESSION['adm_senha'] = null;
        ...
        <nav class="navbar navbar-expand-lg bg-body-tertiary bg-light" data-bs-theme="light">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <d class="navbar-nav">
                        <a class="nav-link" href="./php/consultar_cliente.php">Ver Carros</a>
                </div>
                <div class="navbar-nav">
                    <a class="nav-link rounded btn btn-success ps-3 py-2" href="" data-bs-toggle="modal" data-bs-target="#login_admin">Admin <img src="https://cdn-icons-png.flaticon.com/512/78/78948.png" alt="" width="30px" height="30px" class="ms-3"></a>
                </div>
            </div>
            </div>
        </nav>
                ...
                <div class="col col-4 py-5 mb-5 ps-5">
                    <div class="card bg-dark" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <a class="btn btn-outline-success" href="php/informacoes1.php?car_id=<?php echo $indice['car_id']; ?>"><b>Ver</b></a>
                        </div>
                    </div>
                </div>
            <?php } ?>
                ...
                <div class="modal-dialog modal-lg modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h1 class="modal-title fs-5 text-success" id="exampleModalLabel">Bem vindo, Administrador!</h1>
                            <a type="button" class="btn btn-close btn-danger btn-lg" href="" aria-label="Close"></a>
                        </div>
                        <div class="modal-body">
                            <?php include('./php/login_admin.php'); ?>
                        </div>
